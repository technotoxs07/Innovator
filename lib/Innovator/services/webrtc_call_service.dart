...
// import 'package:innovator/Innovatorscreens/Call/Incoming_Call_screen.dart';
// import 'package:innovator/Innovatorservices/Firebase_Messaging.dart';
// import 'package:innovator/Innovatorservices/call_notification_service.dart';
...
//       throw Exception('Missing or invalid call ID in data');
//     }
//     developer.log('✅ Answering call: $callId');
    
//     currentCallId.value = callId;
    
//     // Get fresh call data from Firestore (safer than relying solely on passed data)
//     final callDoc = await _firestore.collection('calls').doc(callId).get();
//     if (!callDoc.exists) {
//       throw Exception('Call document not found');
//     }
    
//     final firestoreCallData = callDoc.data()!;
//     final isVideoCall = firestoreCallData['isVideoCall'] as bool;
...
//     final offerData = firestoreCallData['offer'] as Map<String, dynamic>?;
//     if (offerData == null) {
//       throw Exception('Missing offer in call data');
//     }
//     final offer = webrtc.RTCSessionDescription(offerData['sdp'] as String, offerData['type'] as String);
