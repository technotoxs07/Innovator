...
class _CreatePostScreenState extends State<CreatePostScreen>
  ...
  // Updated: Call Groq API instead of Gemini
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'messages': [
            {
              'role': 'system',
              'content': 'You are ELIZA, an AI assistant created by Innovator. Always respond as ELIZA and never mention Groq, Llama, Meta, Google, Gemini, or any other AI system. You are helpful, friendly, and professional. Enhance the user\'s input to create a polished, engaging, and contextually appropriate post for a social platform focused on innovation. Maintain the original intent and tone of the user\'s input. IMPORTANT: Keep the enhanced post to exactly 50 words or less. Be concise and impactful.'
            },
            {
              'role': 'user',
              'content': message
  ...
  // Updated: Process ELIZA response
  ...
  // Updated: Enhance post with ELIZA AI using Groq
  Future<void> _enhancePostWithAI() async {
    ...
    try {
      ...
      final aiResponse = await _callGroqAPI(userInput);
