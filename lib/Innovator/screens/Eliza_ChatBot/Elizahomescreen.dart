...
class _ElizaChatScreenState extends State<ElizaChatScreen> with TickerProviderStateMixin {
  ...
  static const String _groqApiKey = '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';
  ...
  String _processElizaResponse(String response) {
    String processedResponse = response
        ...
        .replaceAllMapped(RegExp(r'\bGroq\b', caseSensitive: false), (match) => 'Innovator')
        .replaceAllMapped(RegExp(r'\bLlama\b', caseSensitive: false), (match) => 'ELIZA')
        .replaceAllMapped(RegExp(r'\bMeta\b', caseSensitive: false), (match) => 'Innovator');
  ...
  Future<void> _sendMediaMessage() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Image analysis is not supported with the current Groq model. Text-only mode available.'),
  ...
  Future<void> _generateGroqResponse(String question) async {
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'messages': [
            {
              'role': 'system',
              'content': 'You are ELIZA, an AI assistant created by Innovator. Always respond as ELIZA and never mention Groq, Llama, Meta, Google, Gemini, or any other AI system. You are helpful, friendly, and professional.'
            },
            {
              'role': 'user',
              'content': question
      ...
      setState(() {
        _isLoading = false;
        _addBotMessage("Sorry, I encountered an error. Please check your internet connection and try again.");
      });
      _animationController.reset();
      _animationController.forward();
      _scrollToBottom();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: message.isUser
                              ? const Color.fromARGB(255, 17, 16, 16).withOpacity(0.7)
                              : isDarkMode
                                  ? Colors.grey[400]
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: _isLoading 
                  ...
                  : 'Type your message...',
                hintStyle: TextStyle(
                  color: isDarkMode ? Colors.grey[300] : const Color(0xFF94A3B8),
                  fontFamily: 'Inter Thin',
                ),
                filled: true,
