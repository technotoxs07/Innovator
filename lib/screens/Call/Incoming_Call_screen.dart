...
//       // Construct minimal callData map with id (since answerCall extracts id and fetches from Firestore)
//       final callDataMap = {'id': callId};
      
//       // Answer the call
//       await callService.answerCall(callDataMap);
